...
def execute_thread(exe,ran, func_name):
    ...
    if "c" in exe:
        #os.chdir("./"+appname+"/build/")
        command="python3 invoke.py "+func_name+" ./ctype.exe -s "+str(ran)
        sp.check_output(shlex.split(command))
        #os.chdir("../..")
...
if __name__ == "__main__":
    appname="cctbx-workflow-daydream" ##
    exe_choice_list=["atype.exe", 'btype.exe', "ctype.exe"] ##
    range_choice_list=[[10,20], [5,120], [15,30]] ##
